...
public class SudokuGrid {
	...
	public SudokuGrid cloneSudokuGrid() {
		...
		for (int i = 0; i < 9; i++) {
			for (int j = 0; j < 9; j++) {
				if (this.arrayGrid[i][j].isStartingCell()) {
					arrayGrid[i][j].setStartingCell(true);
				}
			}
		}
	...
	public String toString() {
		return "SudokuGrid [arrayGrid=" + Arrays.toString(arrayGrid) + ", listGrid=" + listGrid + ", segmentGrid="
